...
@section('content')
    ...
    <div  class="layui-fluid" id="layui-fluid" style="text-align: center;">
        ...
        <div class="layui-carousel" id="top_carousel" lay-filter="top_carousel" style="margin:0 auto;line-height: 100%" >
            <div carousel-item="" id="carousel_item">
                @foreach($supportLanguage as $language=>$word)
                    @if(isset($images[$language]))
                        <div class="img-item item_{{$language}}">
                            <b style="color: red;">{{$language}}</b>
                            <img class="picture" src="{{config('common.qnUploadDomain.thumbnail_domain')}}/{{$images[$language]}}?imageView2/0/w/1200/h/1200/interlace/1|imageslim">
                        </div>
                    @endif
                @endforeach
            </div>
            ...
            $('.top_image').each(function(){
                ...
                upload.render({
                    ...
                    , done: function (res, index, upload) {
                        ...
                        common.ajax("{{ url('/backstage/service/message') }}/"+id,param,function(res){
                            loadBar.finish();
