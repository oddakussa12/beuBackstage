    ...
    <div  class="layui-fluid">
        ...
        <table class="layui-table"  lay-filter="user_table">
            ...
            <tr>
                ...
                <th  lay-data="{field:'num_all', width:100}">举报次数</th>
                <th  lay-data="{field:'created_at', width:160}">第一次举报时间</th>
                ...
                <th  lay-data="{field:'user_op', minWidth:320 ,fixed: 'right'}">{{trans('common.table.header.op')}}</th>
            </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="layui-table-cell laytable-cell-1-6">
                            <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="people" target="_blank" href="{{route('report::report.history')}}?details=1&&user_id={{$user->user_id}}">举报历史</a>
                            <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="people" target="_blank" href="{{route('report::report.user')}}?user_id={{$user->user_id}}">被举报的用户</a>
                            <a class="layui-btn layui-btn-warm layui-btn-xs" lay-event="people" target="_blank" href="{{route('report::report.user')}}?user_id={{$user->user_id}}">被举报的帖子</a>
                        </div>
                    </td>
                </tr>
            @endforeach
