...
{{--                <th lay-data="{field:'type', width:100}">类型</th>--}}
                ...
                <th lay-data="{field:'default', width:100}">是否默认</th>
...
{{--                    <td>{{$value->type}}</td>--}}
                    ...
                    <td><input type="checkbox" @if($value->default==1) checked @endif name="default" lay-skin="switch" lay-filter="switchAll" lay-text="是|否"></td>
