        ...
        <form class="layui-form layui-tab-content">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select  name="type" lay-verify="">
                        <option value="1" @if($data->type==1)) selected @endif>虚拟</option>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="limiting" name="limiting" required="required" autocomplete="off" class="layui-input" value="@if(empty($data->limiting)) 0 @else {{$data->limiting}}@endif">
                    </div>
                </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="price" name="price" required="required" autocomplete="off" class="layui-input" value="{{$data->price}}">
                    </div>
                </div>
                <div class="layui-inline">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="start_time" name="start_time" placeholder="开始时间" required="required" autocomplete="off" class="layui-input time" value="{{$data->start_time}}">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">结束时间：</label>
                    <div class="layui-input-block">
                        <input type="text" id="end_time" name="end_time" placeholder="结束时间" required="required" autocomplete="off" class="layui-input time" value="{{$data->end_time}}">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="total" name="total" required="required" class="layui-input" value="{{$data->total}}">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <select  name="status" lay-verify="">
                            <option value="1" @if(!empty($data->status)) selected @endif>上架</option>
                            <option value="0" @if(empty($data->status))  selected @endif>下架</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <img style="width: 200px" id="show" class="show" src="{{config('common.qnUploadDomain.thumbnail_domain')}}{{$data->image}}?imageMogr2/auto-orient/interlace/1|imageslim" />
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        layui.config({
            ...
            form.on('submit(admin_form)', function(data){
                ...
                common.ajax("{{url('/backstage/invitation/good')}}/"+params.id , params , function(res){
            ...
            $('#upload').each(function(){
                ...
                upload.render({
                    ...
                    , done: function (res, index, upload) {
                        ...
                        common.ajax("{{ url('/backstage/invitation/good') }}/"+id,param,function(res){
                            loadBar.finish();
