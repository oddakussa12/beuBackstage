        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input class="layui-input" type="text" readonly lay-verify="datetime" required placeholder="{{trans('common.form.label.date')}}" id="start_time" name="start_time">
                    </div>
                </div>
                <div class="layui-inline">
    ...
    <script>
        layui.config({
            ...
            form.on('submit(common_form)', function(data){
                ...
                common.ajax("{{LaravelLocalization::localizeUrl('/backstage/business/delay_special_goods')}}/", params , function(res){
